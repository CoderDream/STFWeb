	...
	<table id="left" width="100%" height="280" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td width="182" valign="top">
				<div id="container">
					<s:iterator value="list" id="banner">
						<h1 class="type">
							<a href="javascript:void(0)"><s:property value="#banner.name" /></a>
						</h1>
						<div class="content">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td><img src="../resources/image/menu_topline.gif"
							...
							<ul class="MM">
								<s:iterator value="#banner.list" id="subBanner">
									<li><a
										...
										target="main"><s:property value="#subBanner.name" /></a></li>
								</s:iterator>
							</ul>
						</div>
					</s:iterator>
