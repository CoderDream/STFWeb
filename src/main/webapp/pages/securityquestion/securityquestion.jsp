		...
		<tr>
			...
			<td bgcolor="#F7F8F9">
				<table width="98%" border="0" align="center" cellpadding="0"
					...
					<tr>
						<td width="15%" height="26" class="STYLE1"><div align="right"
								class="STYLE2 STYLE1">Old Password:</div></td>
						<td width="85%" height="18" class="STYLE1"><input type="text"></td>
					</tr>
					<tr>
						<td width="15%" height="26" class="STYLE1"><div align="right"
								class="STYLE2 STYLE1">New Password:</div></td>
						<td width="85%" height="18" class="STYLE1"><input type="text"></td>
					</tr>
					<tr>
						<td width="15%" height="26" class="STYLE1"><div align="right"
								class="STYLE2 STYLE1">Repeat New Password:</div></td>
						<td width="85%" height="18" class="STYLE1"><input type="text"></td>
					</tr>
					<tr>
						<td width="15%" height="26" class="STYLE1"><div align="right"
								class="STYLE2 STYLE1">&nbsp;</div></td>
						<td width="85%" class="STYLE1" align=left><input
							type="button" value="Confirm" class="btn_confirm" /></td>
					</tr>
				</table>
			</td>
