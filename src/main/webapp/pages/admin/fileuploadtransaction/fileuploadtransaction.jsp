								...
								<table class="search_result" width="100%" cellspacing="0"
									...
									<tbody>
										<tr>
											...
											<th><label><a href="#">Number [Completed
														Transaction]</a></label></th>
											<th><label><a href="#">Number [Failed
														Transaction]</a></label></th>
											<th width="40px"><label>Details</label></th>
										</tr>
										<tr>
											<td>1</td>
											<td>China Bank</td>
											...
											<td><input type="button" value="Detail"
												onclick="javascript:document.location.href='./fileuploadtransaction_detail.html';" /></td>
										</tr>
										<tr>
											<td>2</td>
											<td>China Bank</td>
