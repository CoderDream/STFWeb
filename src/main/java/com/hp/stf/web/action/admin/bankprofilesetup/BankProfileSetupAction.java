package com.hp.stf.web.action.admin.bankprofilesetup;
...
public class BankProfileSetupAction extends BaseAction {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger
			.getLogger(BankProfileSetupAction.class);
	...
	public String doBankProfileSetup() {
		logger.debug("enter doBankProfileSetup() method");
		return SUCCESS;
	}
