package com.hp.stf.web.action.admin.bankregistration;
...
public class BankRegistrationAction extends BaseAction {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger
			.getLogger(BankRegistrationAction.class);
	...
	public String doBankRegistration() {
